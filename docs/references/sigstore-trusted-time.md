---
source_url: https://blog.sigstore.dev/trusted-time/
...
> Source: https://blog.sigstore.dev/trusted-time/
> Retrieved 2026-06-06 via Scrapling (get).

---

[![Logo](../images/sigstore.png)](https://blog.sigstore.dev/)[About](https://blog.sigstore.dev/about/)

Trusted Time in Sigstore
========================

Aug 2, 2023 by Hayden Blauzvern (Google), Meredith Lancaster (GitHub), Héctor Fernández (Chainguard)
...
Tags: 
[sigstore](https://blog.sigstore.dev/tags/sigstore)
, 
[timestamping](https://blog.sigstore.dev/tags/timestamping)
, 
[rekor](https://blog.sigstore.dev/tags/rekor)
